...
title: "Build a highly available Node.js application using Docker,
  NGINX and AWS ELB"
description: "A multi-level load-balancer architecture using AWS ELB and NGINX for deploying easily scalable dockerized apps."
...
- From the quick start section, select **Amazon Linux 2 AMI**.
